    ...
    <footer className="bg-gradient-to-b from-white-50 to-white-100 text-premium-dark py-16 border-t-4 border-premium-whitesmoke shadow-inner" style={{backgroundColor:'#FAF9F6'}}>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          ...
          <div className="w-full md:w-1/5 flex flex-col items-center md:items-end justify-start md:justify-start mt-12 md:mt-0">
            <h2 className="text-2xl font-dm-sans font-bold mb-2 md:mb-4">Be Social</h2>
            <span className="text-gray-600 mb-4 md:mb-6">Join the Conversation</span>
            <div className="flex space-x-4">
              <a href="#" className="text-premium-dark hover:text-premium-gold transition-colors duration-300" aria-label="Github">
                <Github size={28} />
              </a>
              <a href="#" className="text-premium-dark hover:text-premium-gold transition-colors duration-300" aria-label="Linkedin">
                <Linkedin size={28} />
              </a>
              <a href="#" className="text-premium-dark hover:text-premium-gold transition-colors duration-300" aria-label="Twitter">
                <Twitter size={28} />
              </a>
            </div>
          </div>
